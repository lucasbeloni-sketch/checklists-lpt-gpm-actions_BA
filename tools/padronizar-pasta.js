// Padroniza TODOS os CSVs da pasta no layout de layout.json.
//
...
(async () => {
  if (!COLUNAS.length) {
    throw new Error('layout.json ainda esta vazio (bootstrap). Rode "npm run gerar-layout" primeiro: sem layout nao existe alvo pra padronizar a pasta.');
  }
