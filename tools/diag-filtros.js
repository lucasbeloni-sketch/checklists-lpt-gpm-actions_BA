...
const COMBOS = [
  {
    nome: "E: julho/2026 inteiro + LPT (tipo padrao deste repo)",
  ...
  {
    nome: "G: julho/2026 inteiro + UTD - Visita Prévia-BA (outro tipo, o do repo irmao)",
    servico: "range", inspecao: "range", periodo: ["01/07/2026", "31/07/2026"],
    tipo: "UTD - Visita Prévia-BA", tokenTipo: "UTD - Visita",
  },
  {
