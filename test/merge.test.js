...
const linha = (cod, dataBR, extra = "") =>
  `CONTRATO-X;B-${cod}_VIST;B-${cod};${cod};01;"FULANO DE TAL";${dataBR};"LPT - Visita Prévia-BA"${extra}`;
...
test("mesclar preserva linhas com quebra interna sem reserializar", () => {
  const comQuebra = `CONTRATO-X;B-9_VIST;B-9;9999;01;"FULANO";30/07/2026;"LPT - Visita Prévia-BA";"obs\ncom quebra"`;
  const dest = `${H}\n${comQuebra}\n`;
