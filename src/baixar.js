...
// (LPT) do periodo ancorado em ontem (D-1) -> extrai o CSV do zip ->
// envia/sobrescreve mm.aaaa.csv na pasta Checklists_LPT do Drive.
//
...
(async () => {
  ...
  try {
    ...
    // calibrado pra LPT) subimos o export COMO VEIO. Isso e proposital: inventar
