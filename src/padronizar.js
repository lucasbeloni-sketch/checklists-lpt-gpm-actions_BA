...
//
// A reprojecao e por NOME de coluna. No repo irmao (UTD) isso foi conferido
// contra o GPM celula a celula (npm run conferir, run 31486945862): 0 divergencia
// em 77.676 celulas. Aqui a base nasce do proprio robo, entao cada resposta ja
// vem sob a coluna daquela pergunta por construcao.
//
// O layout (layout.json, gerado por `npm run gerar-layout`) = as colunas que o
// GPM exporta hoje + as perguntas aposentadas que so aparecem nos arquivos
// antigos, mantidas no fim. Por construcao e SUPERCONJUNTO de todos os arquivos
// da pasta, entao a reprojecao nunca descarta resposta.
//
